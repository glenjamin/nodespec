...
function mixin_nodespec(nodespec, deps) {
    ...
    nodespec.assert = deps.assert || default_deps.assert;
    nodespec.ExampleGroup = deps.ExampleGroup || default_deps.ExampleGroup;
    nodespec.Result = deps.Result || default_deps.Result;
...
function describe(description, options, definition) {
    ...
    new_group = new this.ExampleGroup(description, options, definition);
...
function exec() {
    ...
    var overall_result = new this.Result();
    async.forEachSeries(
        this.example_groups,
